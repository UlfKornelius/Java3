...
class TestingClass {
    ...
    private static void performTests(Class testClass) throws RuntimeException {
        TestingClass testingObj;
        try {
            testingObj = (TestingClass)testClass.newInstance();
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
